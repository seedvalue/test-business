    ...
    sealed class EcsRunSysWndGame : IEcsInitSystem, IEcsRunSystem
    {
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            foreach (var entBusiness in _filterEventCreateBusinessView.Value)
            {
                ...
                itemView.TextUpgradeFirstPriceVal.text = "Цена: " + compBusiness.UpgradeFirstPrice.ToString() + "$";
                itemView.TextUpgradeFirstEarnМultiplie.text = "Доход: +" + compBusiness.UpgradeFirstEarnМultiplier.ToString() + "%";
                ...
                itemView.TextUpgradeSecondPriceVal.text = "Цена: " + compBusiness.UpgradeSecondPrice.ToString() + "$";
                itemView.TextUpgradeSecondEarnМultiplie.text = "Доход: +" + compBusiness.UpgradeSecondEarnМultiplier.ToString() + "%";
                itemView.ButtonUpgradeSecond.onClick.AddListener(delegate { OnClickUpgradeSecond(entBusiness); });

                //Удалить обработанный Event
            ...
            foreach (var entBusiness in _filterEventUiUpdateBusinessView.Value)
            {
                ...
                compBusiness.UiView.TextLevelUpPrice.text = "Цена:" + price.ToString() + "$";
                ...
                if (compBusiness.IsUpgrade1Applyed)
                    compBusiness.UiView.TextUpgradeFirstPriceVal.text = "КУПЛЕНО";
                if (compBusiness.IsUpgrade2Applyed)
                    compBusiness.UiView.TextUpgradeSecondPriceVal.text = "КУПЛЕНО";
                //Удалить обработанный Event
